        ...
        <div class="tab-content">
                <div id="bio_data" class="tab-pane container active">
                    ...
                    <div style="margin-top: 15px;" class="row">
                        ...
                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4" style="margin-bottom: 15px;">
                                <button name="clear_btn" id="{{$student_id}}" @if($student->status == 'cleared') disabled @endif data-toggle="modal" data-target="#clear_student{{$student_id}}"  class="btn btn-outline-danger">Student clearance</button>
                        </div>
                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4" style="margin-bottom: 15px;">

...
<div class="row">
    ...
    <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="tab" href="#roles_and_responsibilities">Roles and responsibilities</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-toggle="tab" href="#teaching_classes">Teaching classes</a>
            </li>
          ...
          <div style="margin-top: 10px;">
            ...
            <div class="alert alert-success alert-dismissible">
                    ...
                    <strong>Failed</strong> : {{ Session::get('updated_successfully')}}
            </div>
                     ...
                     <div class="panel panel-primary w-auto" >
                             ...
                             <div class="panel-body">
                                @if (!$teacher_classes->isEmpty())
                                    ...
                                    <button style="float:right; margin-bottom: 10px;" type="button" id="{{$teacher->id}}" name="addButton" data-toggle="modal" data-target="#add_teachingClass_modal{{$teacher->id}}" class="btn btn-success">Add</button>

	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form action="/parents/login" method="post" class="login100-form validate-form" name="login_form">
					@csrf
					...
					<div class="text-center p-t-30">
						<p>Forgot your password? Click <a href="/forgotPassword" style="color: blue;">here</a></p>
						{{-- <span class="txt1">
